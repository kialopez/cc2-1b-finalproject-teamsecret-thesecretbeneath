...
def title_screen_selection():
    ...
    if option.lower() == "play":
        setup_game()  # placeholder unit written
...
ZoneMap = {
    ...
    'a2': {
        ...
        Examination : 'For a labyrinth you would expect something more chaotic but its seemingly empty',
        Solved : False,
        Up : '',
        Down : 'b2',
        Left : 'a1',
    ...
    'a3': {
        ...
        Examination : 'Not like the last room, this room shines the light of LOOT!, but you still cant shake the eerie feeling',
        Solved : False,
        Up : '',
        Down : '',
        Left : 'a2',
    ...
    'a4': {
        ...
        Examination : 'as you look around you find adventurers like your self',
        Solved : False,
        Up : '',
        Down : 'b4',
        Left : '',
    ...
    'b1': {
        ...
        Examination : 'All of your instincts, tells you to RUN...',
        Solved : False,
        Up : '',
        Down : 'c1',
        Left : '',
    ...
    'b2': {
        ...
        Description : 'Lush green plains greets you, with the warmth of the bright sun',
...
def promt():
    ...
    action = input("> ")
    acceptable_action = ['move', 'go', 'trave', 'walk', 'quit', 'examine', 'inspect', 'lool']
    ...
    elif action.lower() in ['examine', 'inpsect', 'interact','look']:
        player_examin(action.lower())
     
def player_move(myAction):
    ask = "Wher would you like to move to?\n"
    dest = input(ask)
    if dest in ['up', 'north']:
...
def player_examin(action):
    if ZoneMap[myPlayer.locatoin][Solved]:
...
def main_game_loop():
    promt()
    # here handle if puzzle have been solved, enemey defeated, explored everything.
